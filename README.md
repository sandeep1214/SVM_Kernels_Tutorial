...
The rubric specifically asks for the code to be **"appropriately licensed for re-use."** 1. On your GitHub, click **Add file** -> **Create new file**.
2. Name it **`LICENSE`**.
3. GitHub will show a button **"Choose a license template."**
4. Pick the **MIT License**.
5. Click **Review and Submit**.

**Final Result:** With this README, the LICENSE, and the Visual Descriptions you've already added to your notebook, you have fulfilled every single requirement in the rubric. You are ready to submit!
